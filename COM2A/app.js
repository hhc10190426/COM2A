...
function buildThreatLabel(ev) {
  ...
  return `<div style="background:#1a1a24;border:1px solid #2a2a38;border-radius:10px;padding:12px 14px;max-width:240px;font-family:'Space Grotesk',sans-serif;pointer-events:none">
